...
"C:\Program Files\IAR Systems\Embedded Workbench 5.0 Kickstart\common\bin\cspybat" "C:\Program Files\IAR Systems\Embedded Workbench 5.0 Kickstart\m16c\bin\m16cproc.dll" "C:\Program Files\IAR Systems\Embedded Workbench 5.0 Kickstart\m16c\bin\m16cemue8a.dll"  %1 --plugin "C:\Program Files\IAR Systems\Embedded Workbench 5.0 Kickstart\m16c\bin\<libsupport_plugin>" --backend -B "--cpu" "M16C" "-p" "C:\Program Files\IAR Systems\Embedded Workbench 5.0 Kickstart\m16c\config\M30626FJP.ddf" "-d" "emue8a" 


@REM Loaded plugins:
@REM    m16cLibSupport.dll
